...
import com.example.nhtha.homeworkoutversion2.presenter.HomePagePresenter;
...
import com.example.nhtha.homeworkoutversion2.view.adapter.HomePageAdapter;
import com.example.nhtha.homeworkoutversion2.view.adapter.PostAdapter;

import java.util.ArrayList;
import java.util.List;

public class HomePageFragment extends Fragment implements View.OnClickListener,HomePageAdapter.OnPostItemClickListener,HomePageCallBackVIew{
    private FloatingActionButton floatingActionButton;

    private HomePageAdapter postAdapter;
    ...
    private HomePagePresenter postPresenter;
    ...
    private void init() {
        ...
        postPresenter = new HomePagePresenter(progressBar);
        postPresenter.setHomePageCallBackVIew(this);
        postDtoID = new ArrayList<>();

        floatingActionButton.setOnClickListener(this);

        postAdapter = new HomePageAdapter(getContext(), new ArrayList<Post>());
